...
/**
 * // private String vin;  //(Приватное поле) - видно - тільки всередині того ж класу
 * //  protected String brand;  //(Защищенное поле) - видно - у межах пакета та в підкласах навіть в інших пакетах
 * //  public int year;     //(Публичное поле) - видно - усюди
 */
...
/**
 * static (метод) - — це метод класу, а не окремого об’єкта.
 * Його можна викликати без створення екземпляра.
 */
 ...
 * абстрактний метод — це метод без реалізації (тіла), який оголошують у абстрактному класі
 * або інтерфейсі. Він лише задає контракт (“що робити”), а як робити змушує реалізувати підклас (або клас, що реалізує інтерфейс).
 *
