...
public class DateOperations {
     ...
     * dates
     */
    // відсортувати у порядку зростання відповідних дат
    ...
    // вивести поточний час у форматі ГГ:ММ (години:хвилини) для всіх часових поясів,
    // що містять zoneSubstring один виведений рядок повинен містити повну назву зони
    // та час у вищезазначеному форматі
